...
static const TString sOutDefault("pp200r9pt9u.et9vz55hightwr.root");
...
void EmbeddingTowerStudy_skinny(const Bool_t isInBatchMode=false, const TString sInput=sInDefault, const TString sOutput=sOutDefault) {
